...
// Status constants
const STATUS_IN_PROGRESS = { id: 0, name: "PENDING", color: "blue.300" };
const STATUS_IN_PENDING = { id: 1, name: "SUCCESS", color: "green.400" };
const STATUS_IN_CANCEL = { id: 2, name: "CANCELED", color: "red.400" };
const STATUS_IN_SUCCESS = { id: 3, name: "SUCCESS", color: "green.400" };
